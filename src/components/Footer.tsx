  ...
  return (
    <footer className="bg-transparent text-lavendar py-6">
      <div className="container mx-auto text-center">
        <p className="mb-4">
          We are a group of students from the University of Calgary dedicated to
          learning cyber security.
        </p>
        <p className="mb-4">
          &copy; 2019 - Present | UCalgary CyberSecurity Club. All rights
          reserved.
        </p>
        <div className="flex justify-center space-x-4 mb-4">
          <a
            href="https://discord.com/invite/dRTqKPatTv"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/cybersecucalgary/"
            target="_blank"
            rel="noopener noreferrer"
          >

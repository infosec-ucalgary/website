...
export const resources = [
    ...
    { category: 'Tools', title: 'Cutter', link: 'https://cutter.re/', description: 'A GUI overlay for radare2, excellent for reverse engineering.' },
    ...
    { category: 'Tools', title: 'Stegosuite', link: 'https://github.com/osde8info/stegosuite', description: 'Tool for hiding information in image files.' },
    ...
    { category: 'Guides', title: 'CTF Wiki', link: 'https://ctf-wiki.org/en/', description: 'Another wiki for helpful CTF information.' },
    ...
    { category: 'Courses', title: 'Network Academy', link: 'https://www.netacad.com/cybersecurity', description: 'Created by Cisco, this has a lot of courses in various areas of information security.' },
